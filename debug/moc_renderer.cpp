...
QT_MOC_LITERAL(1, 9, 19), // "onRenderingComplete"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 17), // "timeToRenderFrame"
QT_MOC_LITERAL(4, 48, 14), // "onTextureReady"
QT_MOC_LITERAL(5, 63, 6), // "GLuint"
QT_MOC_LITERAL(6, 70, 7), // "texture"
QT_MOC_LITERAL(7, 78, 11), // "renderScene"
QT_MOC_LITERAL(8, 90, 15), // "cleanUpRenderer"
QT_MOC_LITERAL(9, 106, 26) // "on_ProjectionMatrixChanged"

    },
    "Renderer\0onRenderingComplete\0\0"
    "timeToRenderFrame\0onTextureReady\0"
    "GLuint\0texture\0renderScene\0cleanUpRenderer\0"
    "on_ProjectionMatrixChanged"
};
...
void Renderer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onRenderingComplete((*reinterpret_cast< double(*)>(_a[1]))); break;
        case 1: _t->onTextureReady((*reinterpret_cast< GLuint(*)>(_a[1]))); break;
        case 2: _t->renderScene(); break;
        case 3: _t->cleanUpRenderer(); break;
        case 4: _t->on_ProjectionMatrixChanged(); break;
        default: ;
        }
        ...
        {
            typedef void (Renderer::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Renderer::onRenderingComplete)) {
                *result = 0;
            }
        }
        {
            typedef void (Renderer::*_t)(GLuint );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Renderer::onTextureReady)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void Renderer::onRenderingComplete(double _t1)
{
...
// SIGNAL 1
void Renderer::onTextureReady(GLuint _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
