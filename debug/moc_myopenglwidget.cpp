...
QT_MOC_LITERAL(1, 15, 25), // "onProjectionMatrixChanged"
QT_MOC_LITERAL(2, 41, 0), // ""
QT_MOC_LITERAL(3, 42, 16), // "onTextureChanged"
QT_MOC_LITERAL(4, 59, 6), // "GLuint"
QT_MOC_LITERAL(5, 66, 7) // "texture"

    },
    "MyOpenGLWidget\0onProjectionMatrixChanged\0"
    "\0onTextureChanged\0GLuint\0texture"
};
...
void MyOpenGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onProjectionMatrixChanged(); break;
        case 1: _t->onTextureChanged((*reinterpret_cast< GLuint(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyOpenGLWidget::onProjectionMatrixChanged)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void MyOpenGLWidget::onProjectionMatrixChanged()
{
